...
if __name__ == '__main__':
    ...
    # train_X_0, train_X_1, train_X_2= np.load('./tw_5_train_data/train_X_0.npy'), np.load('./tw_5_train_data/train_X_1.npy'), np.load('./tw_5_train_data/train_X_2.npy')
    # train_y_0, train_y_1, train_y_2 = np.load('./tw_5_train_data/train_y_0.npy'), np.load('./tw_5_train_data/train_y_1.npy'), np.load('./tw_5_train_data/train_y_2.npy')
