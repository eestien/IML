...
#     conv_layer_1_1 = Conv3D(10, (3, 3, 3), activation='relu', padding='valid')(inputs_pad)
#     conv_layer_1_1 = tf.keras.layers.ZeroPadding3D(padding=(1, 1, 0), data_format=None)(conv_layer_1_1)
#     conv_layer_1_2 = Conv3D(20, (3, 3, 3), activation='relu', padding='valid')(conv_layer_1_1)
#     conv_layer_1_3 = Conv3D(40, (3, 3, 1), activation='relu', padding='same')(conv_layer_1_2)
    
#     conv_layer_2_1 = Conv3D(20, (3, 3, 1), activation='relu', padding='same')(conv_layer_1_3)
#     conv_layer_2_2 = Conv3D(10, (3, 3, 1), activation='relu', padding='same')(conv_layer_2_1)
#     outputs = Conv3D(1, 1, activation='relu', padding='same')(conv_layer_2_2)
...
if __name__ == '__main__':
    ...
    # pixels_norm = 540
    train_X_0, train_X_1, train_X_2, train_X_3 = np.load('./tw_5_train_data/train_X_0.npy'), np.load('./tw_5_train_data/train_X_1.npy'), np.load('./tw_5_train_data/train_X_2.npy'), np.load('./tw_5_train_data/train_X_3.npy')
    train_y_0, train_y_1, train_y_2, train_y_3 = np.load('./tw_5_train_data/train_y_0.npy'), np.load('./tw_5_train_data/train_y_1.npy'), np.load('./tw_5_train_data/train_y_2.npy'), np.load('./tw_5_train_data/train_y_3.npy')
    ...
    del train_X_0, train_X_1, train_X_2, train_X_3
    del train_y_0, train_y_1, train_y_2, train_y_3
    ...
    filename='log_light_model_tw5_relu_5_ep.csv'
    ...
    model.save("./light_model_tw5_relu_5_ep.h5")
